...
def import_data_from_folder(folder_name,no_of_data):
    ...
    for (path, dir, files) in os.walk("./{folder_name}/".format(folder_name=folder_name)):
            for filename in files:
                 ...
                 if ext == '.txt':
                    ...
                    data = data.iloc[:no_of_data,:]           # 22.03.21 추가
